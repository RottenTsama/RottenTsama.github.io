...
var SimpleCore = {
    ...
    changeReadModel: function () {
        ...
        if (SimpleCore.getLocalData('read-mode') == 'night') {
            ...
            $(".cover-img").css({
                'background': "url('/images/cover-night1.jpg')",
                'background-image': '/images/cover-night1.jpg',
            ...
            $(".cover-img").css({
                'background': "url('/images/cover-day1.jpg')",
                'background-image': '/images/cover-day1.jpg',
                'background-size': 'cover',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
